		...
		<>
			<div className='Login_wrap'>
				<div className='Login_box'>
					<img className='styleship_logo' src='/images/styleship_logo.png' alt='스타일쉽 로고' />
					<div className='Login_form'>
						...
						>
							<Input inputPlaceholder='아이디' inputValue={loginId} setValue={setLoginId} inputChar='login' />
							<Input
								inputType='password'
