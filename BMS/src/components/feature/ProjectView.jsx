...
const ProjectView = ({ project, onSaveWorkTeam }) => {
	...
	const regDate = project?.workRegdate || project?.projectDate || project?.regDate || project?.createdAt || null;
	...
	return (
		<div className='ProjectView'>
			...
			<div className='project-task'>
				{activeTab === 'comment' && (
					<CommentTask
						projectId={project.workNo}
						projectCompany={project.projectName}
						projectTitle={project.workTitle}
						workTeam={project.workTeam}
